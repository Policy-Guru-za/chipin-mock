...
const baseView: DashboardDetailViewModel = {
  ...
  payoutMethodLabel: 'Takealot Voucher',
  payoutRecipientDisplay: 'parent@example.com',
  payouts: [],
  shareUrl: 'https://www.gifta.co.za/maya-birthday',
  publicUrl: 'https://www.gifta.co.za/maya-birthday',
  isComplete: true,
  isFunded: false,
  isEditable: false,
};
