...
function VillageTestimonial({ className }: LandingHeroExactBlockProps) {
  ...
  return (
    <div className={testimonialClassName}>
      <blockquote className={styles.villageQuote}>
        &ldquo;My daughter still talks about &lsquo;the present everyone helped with.&rsquo; It made
        her birthday feel so special.&rdquo;
      </blockquote>
