...
| `04_session-placeholder` | Active session placeholder | Active | Codex | `03_placeholder-handoff-proof-model` | Rename this file in place to `spec/04_<topic>.md` before the next session starts, then create the next numbered placeholder at handoff |
