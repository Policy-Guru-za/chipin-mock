...
| `16_dreamboard-pivot-hardening` | Harden active Dreamboard defaults and contain legacy payout/charity compatibility | Active | Codex | `15_dreamboard-truth-cleanup-follow-up` | Tightens first-party voucher-only active flow boundaries, resets default fixtures, and preserves explicit historical compatibility paths |
