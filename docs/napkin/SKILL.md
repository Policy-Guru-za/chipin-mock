...
description: |
  ...
  napkin lives in the repo at `docs/napkin/napkin.md`.
author: Codex
version: 5.0.0
date: 2026-02-06
---
...
else. Internalise what's there and apply it silently. Don't announce that you
read it. Just apply what you know.

If no napkin exists yet, create one at `docs/napkin/napkin.md`:
