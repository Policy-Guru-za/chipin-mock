...
2. [`../DOCUMENT_CONTROL_MATRIX.md`](../DOCUMENT_CONTROL_MATRIX.md)
3. [`../Platform-Spec-Docs/CANONICAL.md`](../Platform-Spec-Docs/CANONICAL.md)
4. [`../forensic-audit/REPORT.md`](../forensic-audit/REPORT.md)
...
- Prioritize user-facing breakage, security risk, permissioning mistakes, data correctness, and contract drift over style.
...
- `P2`: partial regression, missing edge-case handling, incomplete test coverage on a risky path, or operational/documentation drift likely to mislead future work
...
- If a review depends on current uncommitted work, inspect `git status --short` before drawing conclusions.
